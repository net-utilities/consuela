...
test('Expect a request count increase to result in false', function () {
...
test('Expect a request count decrease to result in true', function () {
...
test('Expect request count being the same to result in true', function () {
